...
hold on
plot(Nbs, sum_rate(:, 2), 'k--s','LineWidth',1,'MarkerSize',10)
plot(Nbs, sum_rate(:, 3), 'k--x','LineWidth',1,'MarkerSize',10)
plot(Nbs, sum_rate(:, 4), 'k--d','LineWidth',1,'MarkerSize',10)
plot(Nbs, sum_rate(:, 5), 'k-*','LineWidth',1,'MarkerSize',10)
plot(Nbs, sum_rate(:, 7), 'k-o','LineWidth',1,'MarkerSize',10)
plot(Nbs, sum_rate(:, 6), 'k-','LineWidth',1,'MarkerSize',10)
xlim([min(Nbs), max(Nbs)])
ylim([0, max(max(sum_rate))+30])
