...
T = 50;%50
Nite = 1e4;
variable_s = [16; 18; 20; 22; 24];
variable_s1 = [4; 6; 8; 10; 12];
...
for variable_n = 1 : length(variable_s)
    Nbx = variable_s(variable_n, 1);
    Nby = variable_s1(variable_n, 1);
    Nb = Nbx * Nby;
    Ub = zeros(Nb, Nb);
    for nx = 1 : Nbx
        for ny = 1 : Nby
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
variable_ss = variable_s .* variable_s1;
subplot(1,2,1);
...
xlabel('Number of BS antennas N_B','Fontname','Times')
